...
public class BeautyFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_beauty, container, false);
    ...
    public void getCombination(String token) {
        ...
        response.enqueue(new Callback<JsonObject>() {
            ...
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                Log.d("BFResponse (body)", String.valueOf(response.body()));
                Log.d("BFResponse (code)", String.valueOf(response.code()));
                Log.d("BFResponse (message)", String.valueOf(response.message()));
                Log.d("BFResponse (isSucce)", String.valueOf(response.isSuccessful()));
